...
echo "EIDR_EXTRA_LIB_DIRS = ${EIDR_EXTRA_LIB_DIRS}"
echo "EIDR_EXTRA_LIBS     = ${EIDR_EXTRA_LIBS}"
echo "EIDR_INSTALL_DIR    = ${EIDR_INSTALL_DIR}"
...
EIDR_INC_DIRS="$(${CCTK_HOME}/lib/sbin/strip-incdirs.sh ${EIDR_INC_DIRS})"
EIDR_LIB_DIRS="$(${CCTK_HOME}/lib/sbin/strip-libdirs.sh ${EIDR_LIB_DIRS})"

# Pass options to Cactus
echo "BEGIN MAKE_DEFINITION"
echo "EIDR_DIR      = ${EIDR_DIR}"
echo "EIDR_INC_DIRS = ${EIDR_INC_DIRS}"
echo "EIDR_LIB_DIRS = ${EIDR_LIB_DIRS}"
echo "EIDR_LIBS     = ${EIDR_LIBS}"
echo "END MAKE_DEFINITION"

echo 'INCLUDE_DIRECTORY $(EIDR_INC_DIRS)'
echo 'LIBRARY_DIRECTORY $(EIDR_LIB_DIRS)'
echo 'LIBRARY           $(EIDR_LIBS)'
